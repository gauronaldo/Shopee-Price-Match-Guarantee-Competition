...
|---|---:|---:|---:|
| Pair-head mAP@20 | 0.87903 | 0.87903 | +0.00000 |
| Pair-head Recall@20 | 0.93780 | 0.93780 | +0.00000 |
| Precision at controlled recall | 0.74557 | 0.74557 | +0.00000 |
| False Top-1 variant conflicts | 280 | 280 | +0 |

### Acceptance gates

- mAP non-regression: `true`
- Recall@20 drop no greater than 0.002: `true`
- Precision improved at the Phase 5 recall target: `false`
- Variant-conflict errors did not increase: `true`
- Pilot outcome: **pilot_did_not_pass**

## Training history

| Epoch | Total loss | Random-pair BCE | Hard-negative BCE | Validation mAP@20 |
|---:|---:|---:|---:|---:|
| 1 | 0.03110 | 0.34739 | 0.21417 | 0.87396 |
| 2 | 0.03467 | 0.37165 | 0.16854 | 0.87056 |
| 3 | 0.03276 | 0.35688 | 0.17046 | 0.86726 |
| 4 | 0.03285 | 0.35074 | 0.17936 | 0.86408 |
