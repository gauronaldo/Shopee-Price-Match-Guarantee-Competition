...
def preflight_catalog_attachment_confirmation(config_path: Path) -> dict[str, object]:
    ...
    return {
        ...
        "confirmation_rows_loaded_by_preflight": False,
        "confirmation_metrics_computed_by_preflight": False,
        "prior_confirmation_access_exists": config.artifacts.access_marker.exists(),
        "prior_confirmation_metrics_exist": config.artifacts.metrics.exists(),
